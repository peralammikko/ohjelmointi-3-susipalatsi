...
Address: git@course-gitlab.tuni.fi:tie-0240x-ohjelmointi-3-programming-3_independent_2021/group_template_project.git
...
If you find any bugs and/or missing features you can report them in GitLab https://course-gitlab.tuni.fi/tie-0240x-ohjelmointi-3-programming-3_independent_2021/course/-/issues
...
The actual README mentioned in project description has been lost to the bit space. If you have any questions, feel free to contact the staff, preferably through prog3@tuni.fi or the prog3 teams channel.
